...
export function buildRangeMarkdown(
  ...
  L.push("---");
  L.push(
    "_Generated by the range in the agentic workflows field guide. A model, not an audit: it is only as good as the threat list, and your deployment has threats this list does not._",
  );
  return L.join("\n");
}
